// 🌙 LunarCrush Universal - Shared GraphQL Queries
// ================================================
// Single source of truth for ALL GraphQL queries
// Used by SDK, CLI templates, and any GraphQL clients
...
// ===== CONVENIENCE QUERIES =====
export const GET_BITCOIN_DATA = `
  query GetBitcoinData {
    getCoin(coin: "btc") {
      id name symbol price price_btc market_cap
      percent_change_24h percent_change_7d percent_change_30d
      volume_24h max_supply circulating_supply close
      galaxy_score alt_rank volatility market_cap_rank
    }
  }
`;

export const GET_ETHEREUM_DATA = `
  query GetEthereumData {
    getCoin(coin: "eth") {
      id name symbol price price_btc market_cap
      percent_change_24h percent_change_7d percent_change_30d
      volume_24h max_supply circulating_supply close
...
export const GET_TOP_CRYPTOS = `
  query GetTopCryptos($limit: Int) {
    getCoinsList(sort: "galaxy_score", limit: $limit, desc: "true") {
      symbol name price market_cap galaxy_score alt_rank sentiment
      percent_change_24h social_dominance interactions_24h
    }
  }
`;
...
export const CREATOR_QUERIES = {
	GET_CREATORS_LIST_QUERY,
	GET_CREATOR_QUERY,
} as const;

export const CONVENIENCE_QUERIES = {
	GET_BITCOIN_DATA,
	GET_ETHEREUM_DATA,
	GET_TOP_CRYPTOS,
} as const;
