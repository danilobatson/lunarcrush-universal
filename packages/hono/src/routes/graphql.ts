...
import { typeDefs } from '../graphql/schema'  // Generated schema
import { resolvers } from '../graphql/resolvers'
import type { Hono } from 'hono'
import type { AppContext } from '../types'

// Build the schema from generated typeDefs (Workers-compatible)
const schema = buildSchema(typeDefs)

export const setupGraphQLRoutes = (app: Hono<AppContext>) => {
