// Working resolvers with proper export structure
...
export const resolvers: Resolvers = {
  Query: {
    health: () => {
      ...
      return 'GraphQL resolvers working!';
    },
    ...
    // Mock data resolvers that should work
    getTopicsList: async () => {
...
// Default export for common import patterns
export default resolvers;

console.log('✅ Resolvers exported successfully');
